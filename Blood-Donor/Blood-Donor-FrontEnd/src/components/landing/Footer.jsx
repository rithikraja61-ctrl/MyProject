      ...
      <footer id="contact" className="footer">
        <div className="container footer__inner">
          <div className="footer__brand">
            <h3 className="footer__title">Blood Donor</h3>
            <p className="footer__tagline">Connecting Blood Donors with Patients.</p>
          </div>
          ...
          <div className="footer__links">
            ...
            <ul>
              ...
              <li><a href="mailto:contact@blooddonor.com">Contact</a></li>
            </ul>
          </div>
        ...
        <div className="footer__bottom">
          <div className="container">
            <p>&copy; {new Date().getFullYear()} Blood Donor. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
